...
export default function WhatsAppFloat({ position = 'right' }: WhatsAppFloatProps) {
  ...
  return (
    <div 
      ...
      className={`fixed ${positionClasses} z-50 bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-xl`}
    >
      <svg 
        className="w-5 h-5" 
        fill="currentColor" 
